...
4311	::ffff:127.0.0.1	Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:104.0) Gecko/20100101 Firefox/104.0	337	standard
...
SELECT pg_catalog.setval('public.access_token_token_id_seq', 4311, true);
...
SELECT pg_catalog.setval('public.list_items_list_item_id_seq', 30, true);
...
SELECT pg_catalog.setval('public.log_accesses_log_access_id_seq', 3955, true);
...
SELECT pg_catalog.setval('public.refunds_refund_id_seq', 10, true);
